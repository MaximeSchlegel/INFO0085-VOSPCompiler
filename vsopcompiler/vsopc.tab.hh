...
#ifndef YY_YY_VSOPC_TAB_HH_INCLUDED
# define YY_YY_VSOPC_TAB_HH_INCLUDED
...
namespace yy {
#line 140 "vsopc.tab.hh" // lalr1.cc:403
...
# if defined __cplusplus && 201103L <= __cplusplus
  ...
  parser::make_INT32 ()
  {
    return symbol_type (token::INT32);
  }
  ...
  inline
  parser::symbol_type
  parser::make_INTLITERAL ()
  {
    return symbol_type (token::INTLITERAL);
  }

  inline
  parser::symbol_type
  parser::make_STRLITERAL ()
  {
    return symbol_type (token::STRLITERAL);
  }
  ...
  parser::make_EXTENDS ()
  {
    return symbol_type (token::EXTENDS);
  }
  ...
  parser::make_ISNULL ()
  {
    return symbol_type (token::ISNULL);
  }
  ...
  inline
  parser::symbol_type
  parser::make_OBJECTID ()
  {
    return symbol_type (token::OBJECTID);
  }
  ...
  parser::make_LOWER ()
  {
    return symbol_type (token::LOWER);
  }

  inline
  parser::symbol_type
  parser::make_LOWEREQUAL ()
  {
    return symbol_type (token::LOWEREQUAL);
  }
...
#line 1487 "vsopc.tab.hh" // lalr1.cc:403




#endif // !YY_YY_VSOPC_TAB_HH_INCLUDED
